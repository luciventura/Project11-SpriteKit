...
//  Project11
//
//  Created by Luciene Ventura on 26/04/21.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var ballCollors = ["ballRed", "ballBlue", "ballYellow", "ballGreen", "ballGrey", "ballCyan", "ballPurple"]
    ...
    func makeBall(at position: CGPoint) {
        guard let ballSelected = ballCollors.randomElement() else {return}
